...
//       style={{
//         transform: CSS.Translate.toString(transform),
//         transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", // Añadimos transición suave aquí también
//         opacity: isDragging ? 0.7 : 1,
//         background: "#f9fafb",
//         border: "1px solid #e5e7eb",
//         borderRadius: "12px",
...
//         flexDirection: "column",
//         gap: "8px",
//         minHeight: items.length ? `${items.length * 64 + 80}px` : "160px", // Altura base + espacio para header
//       }}
//     >
//       <div
//         style={{
...
//       >
//           {items.map((item) => (
//             <SortableItem key={item.id} item={item} disabled={isSortingContainer} onRemove={removeItem} onUpdate={updateItem} />
//           ))}
//         </div>
//       </SortableContext> */}
//       <SortableContext
...
//             overflow: "hidden",
//           }}
//           className="transition-[height] duration-300 ease-in-out flex flex-col gap-2"
//         >
//           {items.map((item) => (
//             <SortableItem
//               key={item.id}
